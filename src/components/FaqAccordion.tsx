...
const reviewerFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Limited-time model: you can get up to Rs 40 after authentic verification. When your review is sold, you receive the remaining payout from your 50% revenue share after subtracting that instant payout.",
  },
  {
    id: "rev-4",
    category: "Earnings & Payments",
    ...
    answer:
      "You receive up to Rs 40 soon after verification. The remaining payout is processed within 24 hours of purchase when your review is sold. Payment options include UPI and bank transfer.",
  },
  {
    id: "rev-5",
    category: "Earnings & Payments",
    ...
    answer:
      "No strict minimum threshold. The instant payout of up to Rs 40 is paid after verification, and the rest is transferred automatically upon review sale.",
  },
  {
    id: "rev-6",
    ...
    answer:
      "Videos are typically 30 seconds to 2 minutes long, in-hand with the product, covering genuine user experience according to our simple checklist.",
  },
  {
    id: "rev-7",
    category: "Review Process",
